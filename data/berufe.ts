...
export const berufe: Beruf[] = [
  ...
  },
  {
    ...
    tasks: [
      { id: "bkf-1", title: "Güter auf festen Routen transportieren", description: "Planbare Strecken zwischen Depots und Kunden abfahren.", kiEignung: 75, category: "routine", warum: "Planbare Strecken abfahren ist genau das, worauf autonome Systeme zielen – nur kommen sie langsamer als gedacht." },
  ...
  // ─────────────────────────── Büro & Verwaltung ───────────────────────────
  {
    ...
    tasks: [
      ...
      { id: "st-6", title: "Individuelle Steuerstrategien entwickeln", description: "Gestaltungsmöglichkeiten für konkrete Lebenslagen abwägen.", kiEignung: 50, category: "kreativ", warum: "Für eine konkrete Lebenslage den besten Weg abwägen ist Beratung mit Verantwortung. KI liefert nur Bausteine." },
  ...
  // ─────────────────────────── Handel & Dienstleistung ───────────────────────────
  {
    ...
    tasks: [
      { id: "eh-1", title: "Waren einräumen und Regale auffüllen", description: "Lieferungen auspacken, einsortieren und Präsentation pflegen.", kiEignung: 50, category: "physisch", warum: "Regale auffüllen ist körperliche Arbeit im Laden, aber gut planbar – deshalb teils automatisierbar." },
